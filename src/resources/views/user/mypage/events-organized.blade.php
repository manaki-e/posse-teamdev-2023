                ...
                <ul class="border-b border-gray-300">
                    ...
                    <li>
                        <x-mypage-event-list>
                            ...
                            <x-slot:participants_count>{{ count($event -> eventParticipantLogs) }}</x-slot:participants_count>
                            ...
                            <x-slot:button>
                                <div class="whitespace-nowrap flex flex-col gap-2">
                                    ...
                                    <x-mypage-button-event-cancel action="{{ route('events.cancel', ['event' =>  $event -> id]) }}">
                                        ...
                                        <x-slot:modal_title>主催したイベントを中止にする</x-slot:modal_title>
                                        <x-slot:modal_description>主催したイベントを中止にします。一度イベントを中止にすると、元に戻すことはできないのでご注意ください。</x-slot:modal_description>
                                        <x-slot:method></x-slot:method>
                                        <x-slot:form_slot></x-slot:form_slot>
