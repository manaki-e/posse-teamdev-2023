                                ...
                                <div class="flex flex-col sm:flex-row">
                                    <div class="sm:w-1/4 text-center sm:pr-8 sm:py-4">
                                        <div class="flex flex-col items-center text-center justify-center">
                                            ...
                                            <div class="flex items-center mb-4" @click="activeTab = 0">
                                                <input id="box-1" type="radio" name="request_type" checked
                                                    class="w-4 h-4 bg-gray-100 border-gray-300">
                                                <label for="box-1"
                                                    class="ml-2 text-sm font-medium text-gray-900">アイテム</label>
                                            </div>
                                            <div class="flex items-center" @click="activeTab = 1">
                                                <input id="box-2" type="radio" name="request_type"
                                                    class="w-4 h-4 bg-gray-100 border-gray-300">
                                                <label for="box-2"
                                                    class="ml-2 text-sm font-medium text-gray-900">イベント</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sm:w-3/4 sm:pl-8 sm:py-4 sm:mt-0 text-center sm:text-left">
                                        <div class="flex flex-col items-center text-center justify-center">
                                            ...
                                            <div class="w-full h-1 bg-gray-500 rounded mt-2 mb-4"></div>
                                            <div
                                                class="flex flex-wrap w-full text-sm font-medium text-gray-900 bg-white sm:flex">
                ...
                <div class="mx-auto grid grid-cols-2 items-stretch gap-4">
                    ...
                    <div class="col-span-1">
                        <div class="h-full rounded-lg border border-gray-200 bg-white shadow-sm">
                            <div
                                class="flex flex-col justify-between rounded-lg h-full text-xs shadow-md p-4 pb-1 text-gray-500 bg-white">
                                <div>
                                    <!-- イベント名 -->
                                ...
                                <div class="bottom-0">
                                    ...
                                    <div class="flex justify-between">
                                        <div class="flex flex-wrap gap-1 items-center">
                                            ...
                                            <span
                                                class="items-center gap-1 rounded-full border border-gray-300 bg-gray-50 px-2 py-1 text-xs font-semibold text-gray-400">
                                                {{ $tag->tag->name }}
                                            </span>
                                            @endforeach
                                        </div>
                                        <a href="#" class="divide-y divide-gray-200 flex justify-end">
                                            <div class="flex justify-end space-x-4 p-1 rounded-md hover:bg-gray-50">
                                                <div class="pl-1">
                                                    <img class="w-8 h-8 rounded-full" src="{{ $request->user->icon }}"
                                                        alt="icon">
                                                </div>
                                                ...
                                                <div x-cloak x-show="modelOpen"
                                                    ...
                                                    <div class="mt-5">
                                                        ...
                                                        <div class="flex justify-center items-center">
                                                            <div
                                                                class="flex items-center {{ $app[$request->type_id]['color'] }}">
