<div x-data="{ showModal: false }" x-on:keydown.window.escape="showModal = false">
    <div class="h-12 flex-center">
        <a @click="showModal = true">
            <button class="w-36 flex select-none items-center gap-3 rounded-lg border border-blue-400 py-2 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-blue-400 transition-all hover:opacity-75 focus:ring focus:ring-pink-200 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" type="button" data-ripple-dark="true">
