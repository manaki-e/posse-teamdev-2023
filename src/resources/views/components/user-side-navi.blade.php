    ...
    <div class="flex antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light"
        ...
        <div class="flex" :class=" (isSidebarOpen) ? 'w-48' : 'w-14'">
            ...
            <div class="text-left bg-white shadow-md" :class=" (isSidebarOpen) ? 'w-48' : 'w-14'">
                <!-- Menu button -->
                <button @click="(isSidebarOpen) ? isSidebarOpen = false : isSidebarOpen = true;"
                    class="p-2 transition-colors rounded-lg hover:bg-gray-300 hover:text-black absolute top-3 left-3"
                    :class=" (isSidebarOpen) ? 'text-black' : 'text-gray-500 bg-white'">
                ...
                <a href="#">
                    <div class="pt-5 text-blue-400" :class=" (isSidebarOpen) ? 'flex flex-row' : 'text-center'">
                        ...
                        <p class="font-patua p-1 rounded hover:bg-gray-100"
                            :class="{ 'hidden' : ! isSidebarOpen, 'ml-2 text-base' : isSidebarOpen}">Peer Product
                            Share</p>
                    </div>
                </a>
                <!-- Event -->
                <a href="#">
                    <div href="#" class="text-pink-600"
                        :class=" (isSidebarOpen) ? 'flex flex-row justify-start my-8' : 'text-center my-4'">
                        <div class="ml-4 text-center flex items-center"
                            :class="{ '' : isSidebarOpen, 'mx-auto' : !isSidebarOpen}">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="stroke-current">
                                <path
                                    d="M3 12C3 13.1819 3.23279 14.3522 3.68508 15.4442C4.13738 16.5361 4.80031 17.5282 5.63604 18.364C6.47177 19.1997 7.46392 19.8626 8.55585 20.3149C9.64778 20.7672 10.8181 21 12 21C13.1819 21 14.3522 20.7672 15.4442 20.3149C16.5361 19.8626 17.5282 19.1997 18.364 18.364C19.1997 17.5282 19.8626 16.5361 20.3149 15.4442C20.7672 14.3522 21 13.1819 21 12C21 10.8181 20.7672 9.64778 20.3149 8.55585C19.8626 7.46392 19.1997 6.47177 18.364 5.63604C17.5282 4.80031 16.5361 4.13738 15.4442 3.68508C14.3522 3.23279 13.1819 3 12 3C10.8181 3 9.64778 3.23279 8.55585 3.68508C7.46392 4.13738 6.47177 4.80031 5.63604 5.63604C4.80031 6.47177 4.13738 7.46392 3.68508 8.55585C3.23279 9.64778 3 10.8181 3 12Z"
                        ...
                        <p class="font-patua p-1 rounded hover:bg-gray-100"
                            :class="{'ml-2 text-base' : isSidebarOpen, 'hidden' : ! isSidebarOpen}">Peer Event</p>
                    </div>
                </a>
                <!-- Request -->
                <a href="#">
                    <div href="#" class="mb-4 text-peer-request" :class=" (isSidebarOpen) ? 'flex flex-row'
                        ...
                        <p class="font-patua p-1 rounded hover:bg-gray-100"
                            :class="{ 'hidden' : ! isSidebarOpen, 'ml-2 text-base' : isSidebarOpen}">Peer Request</p>
                    </div>
                </a>
                <!-- アプリ内リンク -->
                    ...
                    <nav x-show="isSidebarOpen" aria-label="Main" class="flex flex-col">
                        ...
                        <a href="#" class="mx-4 my-4 text-center flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    d="M5 21C4.45 21 3.979 20.804 3.587 20.412C3.195 20.02 2.99934 19.5493 3 19V5C3 4.45 3.196 3.979 3.588 3.587C3.98 3.195 4.45067 2.99934 5 3H19C19.55 3 20.021 3.196 20.413 3.588C20.805 3.98 21.0007 4.45067 21 5V19C21 19.55 20.804 20.021 20.412 20.413C20.02 20.805 19.5493 21.0007 19 21H15V19H19V7H5V19H9V21H5ZM11 21V14.85L9.4 16.45L8 15L12 11L16 15L14.6 16.45L13 14.85V21H11Z"
                                    fill="black" />
                            </svg>
                        ...
                        <a href="#" class="mx-4 text-center flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M19.7151 0.855469H4.28655C3.33978 0.855469 2.57227 1.62298 2.57227 2.56975V21.4269C2.57227 22.3737 3.33978 23.1412 4.28655 23.1412H19.7151C20.6619 23.1412 21.4294 22.3737 21.4294 21.4269V2.56975C21.4294 1.62298 20.6619 0.855469 19.7151 0.855469Z"
                                    stroke="black" stroke-width="1.71429" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                                    d="M2.57227 17.9978H21.4294M7.71512 5.14062H16.2866M7.71512 9.42634H16.2866M7.71512 13.7121H12.858"
                                    stroke="black" stroke-width="1.71429" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                            <p class="font-patua ml-2 p-1 text-base rounded hover:bg-gray-100">
