            ...
            <div class="text-left bg-white shadow-md" :class=" (isSidebarOpen) ? 'w-52' : 'w-14'">
                ...
                <a href="{{ route('items.index')}}">
                    <div class="pt-5 text-blue-400" :class=" (isSidebarOpen) ? 'flex flex-row' : 'text-center'">
                        ...
                        <p x-cloak class="font-patua p-1 rounded hover:bg-gray-100" :class="{ 'hidden' : ! isSidebarOpen, 'ml-2 text-base' : isSidebarOpen}">Peer Product
                            Share</p>
                    </div>
                </a>
                <!-- Event -->
                <a href="{{ route('events.index') }}">
                    <div href="#" class="text-pink-600" :class=" (isSidebarOpen) ? 'flex flex-row justify-start my-8' : 'text-center my-4'">
                        ...
                        <p x-cloak class="font-patua p-1 rounded hover:bg-gray-100" :class="{'ml-2 text-base' : isSidebarOpen, 'hidden' : ! isSidebarOpen}">Peer Event</p>
                    </div>
                </a>
                <!-- Request -->
                <a href="{{ route('requests.index') }}">
                    <div href="#" class="mb-4 text-peer-request" :class=" (isSidebarOpen) ? 'flex flex-row'
                        ...
                        <p x-cloak class="font-patua p-1 rounded hover:bg-gray-100" :class="{ 'hidden' : ! isSidebarOpen, 'ml-2 text-base' : isSidebarOpen}">Peer Request</p>
                    </div>
                </a>
                <!-- アプリ内リンク -->
                <div x-show="isSidebarOpen">
                    <nav x-cloak x-show="isSidebarOpen" aria-label="Main" class="flex flex-col">
                        ...
                        <a href="#" class="mx-4 my-4 text-center flex items-center">
                            ...
                            <p class="font-patua ml-2 p-1 text-sm rounded hover:bg-gray-100">
                                参加イベント
                            </p>
                        </a>
