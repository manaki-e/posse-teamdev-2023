            ...
            <div class="text-left bg-white shadow-md" :class=" (isSidebarOpen) ? 'w-52' : 'w-14'">
                ...
                <nav aria-label="Main" class="flex flex-col">
                    ...
                    <a href="{{ route('requests.index') }}">
                        <div class="mb-4 text-peer-request" :class=" (isSidebarOpen) ? 'flex flex-row' : 'text-center'">
                            <div class="ml-4 text-center flex items-center" :class="{ '' : isSidebarOpen, 'mx-auto' : !isSidebarOpen}">
                                <x-icon-pr></x-icon-pr>
                            </div>
                    ...
                    <a href="{{ route('mypage.events.joined') }}" class="mx-4 my-4 text-center flex items-center">
                        ...
                        <p x-cloak x-show="isSidebarOpen" x-transition.duration.100ms class="font-patua ml-2 p-1 text-sm">
                            参加イベント
                        </p>
                    </a>
                    <a href="{{ route('mypage.events.organized') }}" class="mx-4 my-4 text-center flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
