        ...
        <div class="sm:w-1/4 text-center sm:pr-8 sm:py-4">
          <div class="flex flex-col items-center text-center justify-center">
            ...
            <div class="flex items-center mb-4">
                ...
                <label for="box-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">利用可能</label>
            </div>
            <div class="flex items-center">
                ...
                <label for="box-2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">利用不可</label>
            </div>
          </div>
        </div>
