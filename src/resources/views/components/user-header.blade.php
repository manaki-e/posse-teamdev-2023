...
<header class="text-gray-600 body-font">
    <div class="mx-3 flex justify-between p-2 flex-col md:flex-row items-center">
        <div {{ $attributes->merge(['class' => 'flex '.$textColor]) }}>
            <a class="flex title-font font-medium items-center ml-10 mb-4 md:mb-0">
            ...
            <div x-data="{ tooltip: false }" x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false"
                ...
                <div class="flex justify-between items-center">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            d="M6.66602 10.6654V5.33203H8.33268C8.77471 5.33203 9.19863 5.50763 9.51119 5.82019C9.82375 6.13275 9.99935 6.55667 9.99935 6.9987C9.99935 7.44073 9.82375 7.86465 9.51119 8.17721C9.19863 8.48977 8.77471 8.66536 8.33268 8.66536H6.66602"
                            stroke="black" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                ...
                <div x-cloak x-show.transition.origin.top="tooltip"
                    class="absolute w-32 top-14 z-10 p-2 text-sm leading-tight text-white bg-black bg-opacity-40 rounded-lg shadow-lg animate-none">
            ...
            <div class="flex justify-center items-center">
                <div x-data="{ open: false }" class="flex justify-center items-center">
                    <div @click="open = !open"
                        ...
                        :class="{'transform transition duration-300 ': open}"
