<div class="container mx-auto flex flex-wrap p-5 pb-0 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            ...
            <div class="flex items-center gap-2 bg-black text-white px-5 py-2.5 rounded-md shadow">
            ...
            <!-- <button class="inline-flex items-center bg-gray-100 border-0 mr-5 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">B 5000</button> -->
        </nav>
</div>
